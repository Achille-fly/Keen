...
const POOL = [
  ...
  {id:3,   dim:"impulsivity", w:1.1, text:"During a video game, you lose on an unexpected move",opts:["Rage quit or make an aggressive gesture","I protest verbally","I accept with a bit of inner frustration","I take it well, it's just a game"]},
  ...
  {id:10,  dim:"impulsivity", w:1.0, text:"You're reading and you hear an interesting conversation nearby",opts:["I listen and spontaneously join in","I eavesdrop but stay with my book","I resist the urge to listen","I put headphones on to avoid the temptation"]},
  {id:11,  dim:"impulsivity", w:1.1, text:"Your phone battery is at 5% and you don't have a charger",opts:["I start panicking and texting everyone immediately","I feel anxious but try to manage it","I calmly wrap up what I'm doing","I don't worry, I'll deal with it when it dies"]},
  {id:12,  dim:"impulsivity", w:0.9, text:"A friend is telling a long story and you already know the ending",opts:["I blurt out the ending immediately","I hint that I know but let them continue","I listen patiently without letting on","I genuinely enjoy hearing their version"]},
  {id:13,  dim:"impulsivity", w:1.2, text:"You see something you want on sale but you weren't planning to buy it",opts:["I buy it without thinking twice","I buy it after a very quick consideration","I sleep on it and decide tomorrow","I walk away, it wasn't in my plan"]},
  {id:14,  dim:"impulsivity", w:1.0, text:"You're in a meeting and someone proposes an idea you disagree with",opts:["I immediately voice my disagreement","I raise my hand right away","I wait for a natural pause then speak","I write down my thoughts to share later"]},
  {id:15,  dim:"impulsivity", w:1.1, text:"You finish work early. An unplanned but tempting activity comes up",opts:["I drop everything and go immediately","I quickly wrap up and head out","I finish properly then consider going","I stick to my original plans for the evening"]},
  {id:16,  dim:"impulsivity", w:1.0, text:"Someone you follow posts something factually wrong on social media",opts:["I comment immediately and publicly","I send a quick private message","I consider whether it's worth engaging","I ignore it unless it's harmful"]},
  {id:17,  dim:"impulsivity", w:1.2, text:"You're watching a movie and it starts very slowly",opts:["I switch to something else within minutes","I check my phone but keep it on","I give it 20–30 minutes before deciding","I trust the process and keep watching"]},
  ...
  {id:19,  dim:"impulsivity", w:1.0, text:"You're waiting for an important email that hasn't arrived",opts:["I refresh every few minutes","I check a few times throughout the day","I check once in the evening","I wait until the deadline to follow up"]},
  {id:20,  dim:"impulsivity", w:1.1, text:"You're playing a board game and losing badly",opts:["I look for a reason to stop or restart","I become visibly less engaged","I continue but feel the frustration building","I stay fully in it and enjoy the challenge"]},
  {id:21,  dim:"impulsivity", w:1.0, text:"A coworker takes credit for your idea in a meeting",opts:["I correct the record immediately in front of everyone","I mention it directly after the meeting","I bring it up with my manager later","I let it go and focus on the next thing"]},
  {id:22,  dim:"impulsivity", w:0.9, text:"You realize mid-trip you forgot something important at home",opts:["I turn around immediately regardless of cost","I quickly weigh the options and likely turn back","I think it through calmly before deciding","I continue and figure out an alternative"]},
  {id:23,  dim:"impulsivity", w:1.1, text:"Someone challenges your opinion publicly",opts:["I defend it immediately and firmly","I quickly explain my reasoning","I pause to consider their point first","I genuinely listen before responding"]},
  {id:24,  dim:"impulsivity", w:1.2, text:"You get a notification while trying to focus on deep work",opts:["I check it immediately every time","I usually check within a few minutes","I check at set intervals","I put my phone on silent and check later"]},
  {id:25,  dim:"impulsivity", w:1.0, text:"A street vendor tries to pressure you into buying something",opts:["I either buy or walk away very quickly","I engage briefly then leave","I listen politely then make a considered decision","I calmly say no thanks from the start"]},
  ...
  {id:28,  dim:"riskTolerance", w:1.1, text:"You must make an important decision without all the information",opts:["I wait until I have all the data","I do additional research","I decide with what I have","I act immediately and adjust later"]},
  ...
  {id:30,  dim:"riskTolerance", w:1.2, text:"You're offered to quit your job for a personal project with 60% chance of success",opts:["I refuse categorically","I refuse but think about it for a long time","I might accept if conditions are right","I accept, the opportunity is too good"]},
  ...
  {id:33,  dim:"riskTolerance", w:1.2, text:"You can choose between a comfortable fixed salary or a variable that could double or halve",opts:["Fixed, stability above all","Fixed, but it's a shame","Variable, if conditions are good","Variable directly, I want to maximize"]},
  {id:34,  dim:"riskTolerance", w:0.9, text:"You try a new recipe for important guests tonight",opts:["Never, I make a known recipe","I try it but with a backup plan","I try it with confidence","I try it and improvise if it fails"]},
  ...
  {id:36,  dim:"riskTolerance", w:1.1, text:"A new investment opportunity promises high returns but with significant uncertainty",opts:["I avoid it entirely","I put in a small amount I can afford to lose","I research thoroughly and invest a reasonable amount","I go in substantially, risk is part of the game"]},
  {id:37,  dim:"riskTolerance", w:1.0, text:"You're offered a promotion that requires relocating to a new city",opts:["I decline, too much upheaval","I seriously consider but likely decline","I weigh pros and cons carefully","I jump at the chance for a fresh start"]},
  {id:38,  dim:"riskTolerance", w:0.9, text:"At a social event, you can join a group where you know no one or wait for someone you know",opts:["I wait for someone I know","I hover near groups but don't join","I introduce myself to the nearest group","I dive into the most interesting conversation"]},
  {id:39,  dim:"riskTolerance", w:1.2, text:"You find out a new restaurant just opened nearby with great reviews but long lines",opts:["I'll wait until the hype dies down","I'll check it out in a month or two","I'll try to go this week","I'm going tonight"]},
  {id:40,  dim:"riskTolerance", w:1.0, text:"A startup you believe in is raising funding",opts:["I wouldn't invest in startups","I'd put in a token amount","I'd invest a meaningful but cautious amount","I'd go all-in if I believe in it"]},
  {id:41,  dim:"riskTolerance", w:1.1, text:"You're about to submit a project but realize you could improve it further with more time",opts:["I always ask for more time","I usually ask for a brief extension","I submit as-is if it's good enough","I submit immediately and improve the next version"]},
  {id:42,  dim:"riskTolerance", w:1.0, text:"You have the option to lock in a guaranteed 5% annual return or invest for potentially 20% (with possible loss)",opts:["5% guaranteed, always","5% guaranteed, mostly","I'd split it 50/50","I'd go all in on the higher potential"]},
  {id:43,  dim:"riskTolerance", w:0.8, text:"You're crossing a street and the light is red but there's no traffic visible",opts:["I wait for the green light no matter what","I wait but I'm frustrated","I look both ways and cross carefully","I cross without much thought"]},
  {id:44,  dim:"riskTolerance", w:1.2, text:"Someone offers you a ticket to an event tonight that you know nothing about",opts:["I decline, I don't like the unknown","I'd want more details first","I'd go if the timing works","I'd say yes immediately"]},
  {id:45,  dim:"riskTolerance", w:1.0, text:"A friend bets you $100 on something you're unsure about but feel optimistic",opts:["I decline, not worth the risk","I negotiate a smaller amount","I accept the $100 bet","I try to raise the stakes"]},
  {id:46,  dim:"riskTolerance", w:1.1, text:"You're asked to give a speech or presentation with only 30 minutes of preparation",opts:["I try to postpone or decline","I accept nervously and prepare intensely","I accept, I'll make it work","I embrace it, I do my best work under pressure"]},
  {id:47,  dim:"riskTolerance", w:1.0, text:"You discover a shortcut that could save significant time but you've never used it",opts:["I stick to the known route","I look it up first before trying","I try it the next time I'm not in a rush","I try it immediately"]},
  {id:48,  dim:"riskTolerance", w:0.9, text:"You're ordering at a restaurant and you can't decide between a safe choice and something very unusual",opts:["I always go with the safe choice","I usually go safe with one unusual side","I often go unusual","I almost always pick the most adventurous option"]},
  {id:49,  dim:"riskTolerance", w:1.2, text:"Your friend suggests an impromptu road trip this weekend with no fixed plan",opts:["No thanks, I need to plan ahead","I'd consider it if we had some structure","I'd join with minimal planning","I'm already packing"]},
  {id:50,  dim:"riskTolerance", w:1.0, text:"You're thinking about starting a side business",opts:["The risk stops me from starting","I'd start very small and cautiously","I'd invest a reasonable amount to get going","I'd go full-speed from day one"]},
  ...
  {id:52,  dim:"patience", w:1.0, text:"A friend owes you $50 for 2 months. They don't seem to remember",opts:["I bring it up as soon as possible","I wait a bit more then remind them","I drop a very gentle hint","I let it go, the friendship is worth more"]},
  {id:53,  dim:"patience", w:1.1, text:"You're learning a new skill. Progress seems slow",opts:["I give up quickly if it doesn't come","I persist but with growing frustration","I persist calmly accepting the slowness","I love the process, the result is secondary"]},
  ...
  {id:59,  dim:"patience", w:1.2, text:"The first episode of a show is slow but they say it picks up at episode 4",opts:["I stop halfway through the first","I watch the first then give up","I watch until episode 2 then decide","I trust the process and watch until episode 4"]},
  {id:60,  dim:"patience", w:1.0, text:"You've been waiting for a professional opportunity for several months",opts:["I look for something else immediately","I follow up regularly and get impatient","I wait while continuing to prepare","I wait serenely, it will come"]},
  {id:61,  dim:"patience", w:1.1, text:"You're in a very long queue at a theme park. The wait is 90 minutes",opts:["I leave and find something with no wait","I stay but check my phone the whole time","I stay and find ways to pass the time","I enjoy the time to chat or observe"]},
  {id:62,  dim:"patience", w:1.0, text:"You're waiting for a friend who is 20 minutes late with no message",opts:["I leave after 10 minutes","I send a somewhat firm message","I send a casual 'everything ok?' message","I wait without stress, life happens"]},
  ...
  {id:64,  dim:"patience", w:1.2, text:"You're stuck on a problem for an hour with no solution",opts:["I ask for help or give up","I try a different approach immediately","I keep working methodically","I find the challenge energizing"]},
  {id:65,  dim:"patience", w:1.0, text:"A negotiation or project is taking weeks longer than expected",opts:["I push hard to accelerate or walk away","I express frustration and set a hard deadline","I check in regularly but stay flexible","I trust the timeline and stay focused on quality"]},
  {id:66,  dim:"patience", w:1.1, text:"You've made a long-term investment. Markets are flat for months",opts:["I'm tempted to reallocate","I check it frequently and worry","I review quarterly with calm","I almost never check, it's long-term"]},
  {id:67,  dim:"patience", w:1.0, text:"You're building a complex LEGO set or puzzle. Progress is slow",opts:["I lose interest within an hour","I push through but look for shortcuts","I work steadily through it","I love the methodical progress"]},
  {id:68,  dim:"patience", w:0.8, text:"A webpage is loading slowly",opts:["I close and reopen immediately","I give it a few seconds then refresh","I wait while reading what's loaded","I barely notice the wait"]},
  {id:69,  dim:"patience", w:1.2, text:"You're learning a musical instrument. After 2 months you still can't play a full song",opts:["I've already considered stopping","I'm frustrated but still practicing","I'm consistent but realistic about pace","I'm enjoying the journey completely"]},
  {id:70,  dim:"patience", w:1.0, text:"You've been dieting for a month with minimal visible results",opts:["I've already changed my approach twice","I'm questioning if it works","I stay the course and trust the process","I barely think about results, habits are what matter"]},
  {id:71,  dim:"patience", w:1.1, text:"A software update is downloading and will take 45 minutes",opts:["I cancel and try to find a faster way","I do something else but check often","I do something productive and check once","I completely forget about it until it's done"]},
  ...
  {id:73,  dim:"patience", w:0.9, text:"A construction project near your home is noisy and will last 6 months",opts:["I actively look for solutions or complain","I'm annoyed daily but adapt","I accept it and focus on what I can control","I barely notice it after the first week"]},
  {id:74,  dim:"patience", w:1.2, text:"You started writing a book or long personal project. Progress is very slow",opts:["I've abandoned it more than once","I go through frequent periods of discouragement","I make steady progress with occasional lulls","I'm methodical and fully committed for the long haul"]},
  {id:75,  dim:"patience", w:1.0, text:"Your flight is delayed by 2 hours",opts:["I immediately look for alternatives or complain","I'm visibly frustrated and keep checking","I find something to do and check occasionally","I settle in and enjoy the unplanned free time"]},

  // ── ANALYTICAL DEPTH (25) ──
  {id:76,  dim:"analyticalDepth", w:1.2, text:"You must choose between two similar apartments",opts:["I take the one I like instinctively","I quickly compare the key points","I make a detailed comparison table","I analyze for weeks considering all possible criteria"]},
  ...
  {id:78,  dim:"analyticalDepth", w:1.1, text:"You have a strong intuition about something but no proof",opts:["I follow my instinct without looking further","I quickly look for confirmation","I look for evidence before acting","I don't move without solid proof"]},
  ...
  {id:80,  dim:"analyticalDepth", w:1.1, text:"A friend asks your advice on a difficult choice",opts:["I give my immediate gut reaction","I ask a few key questions then advise","I take time to analyze it fully with them","I want all the details before weighing in"]},
  {id:81,  dim:"analyticalDepth", w:1.0, text:"You need to quickly estimate a fair price to sell something",opts:["I give a number by feel","I vaguely look at market prices","I do a serious comparison of 5–10 references","I build a complete valuation model"]},
  ...
  {id:84,  dim:"analyticalDepth", w:1.1, text:"You're asked your opinion on a topic you know little about",opts:["I give my opinion immediately","I give an opinion noting my limitations","I ask for time to look into it","I refuse to comment without being sure"]},
  {id:85,  dim:"analyticalDepth", w:1.0, text:"You watch a movie",opts:["I let myself be carried away without thinking","I follow the story and feel the emotions","I sometimes analyze the direction","I constantly analyze the narrative structure"]},
  {id:86,  dim:"analyticalDepth", w:1.1, text:"You need to assemble flat-pack furniture",opts:["I start immediately without reading instructions","I glance at the instructions then go by feel","I read the full instructions once then build","I study the instructions thoroughly and follow step by step"]},
  {id:87,  dim:"analyticalDepth", w:1.0, text:"You're cooking something new",opts:["I improvise as I go","I read the recipe once and ad-lib the rest","I follow the recipe fairly closely","I follow every step precisely"]},
  {id:88,  dim:"analyticalDepth", w:0.8, text:"Someone asks you to recommend a book or movie",opts:["I give the first thing that comes to mind","I suggest one or two favorites quickly","I ask what they like first, then recommend","I need to know their full preferences before suggesting anything"]},
  {id:89,  dim:"analyticalDepth", w:1.2, text:"You're diagnosing why your plant is dying",opts:["I try the first solution that comes to mind","I try the most common fix","I research possible causes before acting","I systematically test each variable to isolate the cause"]},
  {id:90,  dim:"analyticalDepth", w:1.0, text:"You're setting up a new device or app",opts:["I skip everything and figure it out as I go","I get started and check the help menu when stuck","I read the getting started guide","I read the full documentation before touching anything"]},
  {id:91,  dim:"analyticalDepth", w:1.1, text:"You're reviewing a contract or document",opts:["I skim the main points and sign","I read it but focus on key sections","I read it carefully and ask questions","I read every clause and cross-reference everything"]},
  {id:92,  dim:"analyticalDepth", w:1.0, text:"Someone proposes a shortcut on a hiking trail you don't know",opts:["I take it immediately, sounds good","I consider it briefly and likely take it","I check the map first","I stick to the marked path, shortcuts are risky"]},
  {id:93,  dim:"analyticalDepth", w:1.2, text:"You're deciding what to order at a new restaurant",opts:["I go with my gut on the first thing that sounds good","I narrow it down quickly to 2–3 options","I read the whole menu carefully","I ask the waiter detailed questions about multiple dishes"]},
  {id:94,  dim:"analyticalDepth", w:0.9, text:"Someone shares a surprising statistic with you",opts:["I accept it and share it further","I note it but don't verify","I look it up when I have a chance","I immediately check the source and methodology"]},
  {id:95,  dim:"analyticalDepth", w:1.1, text:"You're buying a used car",opts:["I buy based on how it looks and feels","I do a basic check and test drive","I research the model, have it inspected","I research extensively and consult multiple experts"]},
  {id:96,  dim:"analyticalDepth", w:1.0, text:"You need to pick a health insurance plan",opts:["I pick the first decent-looking option","I compare 2–3 options on price","I compare several plans across multiple criteria","I analyze every plan exhaustively including fine print"]},
  {id:97,  dim:"analyticalDepth", w:1.2, text:"A friend proposes a business idea to you",opts:["I react enthusiastically or not based on feel","I give quick gut-level feedback","I think it through before giving structured feedback","I want to build a full analysis before saying anything"]},
  {id:98,  dim:"analyticalDepth", w:0.8, text:"You're playing a strategy board game for the first time",opts:["I jump in and learn as I play","I read the rules briefly then play","I read all the rules before starting","I read the rules and watch a tutorial before playing"]},
  {id:99,  dim:"analyticalDepth", w:1.0, text:"You need to write an important email",opts:["I write what comes and send","I draft quickly and do one pass","I write, review and revise before sending","I draft, revise multiple times and often ask someone to review"]},
  {id:100, dim:"analyticalDepth", w:1.1, text:"You're choosing between two job offers",opts:["I go with the one that excites me more","I weigh a few key factors quickly","I create a structured comparison across many dimensions","I analyze every aspect exhaustively over several weeks"]},
  ...
  {id:102, dim:"lossAversion", w:1.2, text:"You rent a movie you don't like at all",opts:["I stop without hesitation","I skip or check my phone but stay","I watch to the end hoping it improves","I finish it no matter what, I paid for it"]},
  ...
  {id:104, dim:"lossAversion", w:1.1, text:"You invest time in a project that seems doomed to fail",opts:["I stop immediately and move on","I try a bit more but know I'll stop","I struggle to let go, I've already invested too much","I'll go to the end, no way I'm giving up"]},
  {id:105, dim:"lossAversion", w:1.3, text:"You missed an opportunity by being overly cautious",opts:["I forget it easily, others will come","I blame myself a bit but move on","I ruminate quite a while on this missed chance","It obsesses me, I replay the scenario on loop"]},
  {id:106, dim:"lossAversion", w:1.0, text:"You lose at a game 3 times in a row",opts:["I don't care, it's random","Slightly frustrated but still fun","I start getting seriously annoyed","I need to recover my losses before stopping"]},
  {id:107, dim:"lossAversion", w:1.1, text:"You have a subscription you never use",opts:["I cancel immediately","I cancel after a few days of procrastination","I continue 'just in case' for a few months","I keep it for a long time, I already paid"]},
  {id:108, dim:"lossAversion", w:0.9, text:"You missed a great sale you had spotted",opts:["Too bad, I'll find another","A little regret, it passes quickly","I blame myself, I should have bought","It gnaws at me, why didn't I act?"]},
  {id:109, dim:"lossAversion", w:1.2, text:"You sold something too early and its price doubled",opts:["Happy I sold when it was right for me","A bit of disappointment but it's normal","Very frustrated by the missed gain","Impossible to think about without rage"]},
  {id:110, dim:"lossAversion", w:1.0, text:"Someone wronged you and you can't remedy it",opts:["I turn the page quickly","It affects me for a few days then I let go","I ruminate quite a long time","I never truly forget it"]},
  {id:111, dim:"lossAversion", w:1.1, text:"You book a non-refundable hotel but your plans change",opts:["I cancel and accept the loss","I try to resell or transfer the booking","I go anyway to not waste the money","I feel terrible about the wasted money for weeks"]},
  {id:112, dim:"lossAversion", w:1.0, text:"You backed a sports team or candidate that lost",opts:["I forget it quickly, it happens","I'm disappointed but move on by next day","I feel down about it for several days","It stays with me and affects my mood for a while"]},
  {id:113, dim:"lossAversion", w:0.9, text:"A company you recommended to someone performs poorly afterward",opts:["It's outside my control, I move on","I feel briefly bad but don't overthink it","I worry about having given bad advice","I replay my recommendation and feel guilty for a long time"]},
  {id:114, dim:"lossAversion", w:1.2, text:"You miss a flight due to your own mistake",opts:["I immediately focus on finding the next one","I'm frustrated but shift to problem-solving quickly","I feel terrible and think about what went wrong","I have a hard time functioning until the situation is resolved"]},
  {id:115, dim:"lossAversion", w:1.0, text:"You accidentally break something of sentimental value",opts:["I feel brief regret and move on","I feel sad but accept it","I feel quite bad for a while","It haunts me for a long time"]},
  {id:116, dim:"lossAversion", w:1.1, text:"You make a decision you later regret",opts:["I note the lesson and move forward","I think about it briefly and let go","I ruminate and second-guess myself for a while","I can't stop replaying the decision in my head"]},
  {id:117, dim:"lossAversion", w:1.0, text:"You give away something then realize you needed it",opts:["I shrug and find an alternative","I'm mildly annoyed but it's fine","I genuinely regret giving it away","I think about it every time I need that thing"]},
  {id:118, dim:"lossAversion", w:0.8, text:"You spend time creating something that doesn't turn out well",opts:["I ditch it and try a different approach","I feel briefly frustrated then try again","I feel deflated and need time to recover","I lose motivation for the whole project for a while"]},
  {id:119, dim:"lossAversion", w:1.2, text:"You pass on a business or investment opportunity that later becomes very successful",opts:["These things happen, I focus on next opportunities","I feel some regret but don't dwell","I think about it frequently for weeks","I bring it up often and it's a long-lasting regret"]},
  {id:120, dim:"lossAversion", w:1.0, text:"A relationship (friendship or romantic) ends unexpectedly",opts:["I feel sad briefly and adapt","I go through a difficult period but recover","I struggle for quite a long time","The loss stays with me and affects future relationships"]},
  {id:121, dim:"lossAversion", w:1.1, text:"You're eliminated early in a competition you prepared for",opts:["I congratulate the winner and move on","I'm disappointed but recover by next day","I feel the loss for several days","I question whether I'm good enough for a long time"]},
  {id:122, dim:"lossAversion", w:1.0, text:"You donate to a cause that turns out to be less impactful than expected",opts:["I note it for future decisions and move on","I feel mild disappointment","I wish I had done more research beforehand","I feel guilty about it for a long time"]},
  {id:123, dim:"lossAversion", w:0.9, text:"You choose a restaurant that turns out to be disappointing",opts:["I laugh it off and try somewhere else next time","I note it and move on","I feel like the evening was wasted","I feel disproportionately bad about the choice"]},
  {id:124, dim:"lossAversion", w:1.2, text:"You receive negative feedback on something you worked hard on",opts:["I extract the useful parts and move on","I feel stung briefly but use the feedback","I dwell on it and feel discouraged","The criticism affects my confidence significantly"]},
  {id:125, dim:"lossAversion", w:1.0, text:"A plan you organized falls apart at the last moment",opts:["I pivot quickly to something else","I'm frustrated but adapt","I feel the disappointment for several days","I struggle to let go of how it was supposed to be"]},

  // ── SELF-CONFIDENCE (25) ──
  {id:126, dim:"selfConfidence", w:1.2, text:"You have a strong conviction. Everyone around you says the opposite",opts:["I immediately revise my position","I start doubting myself","I maintain but listen to arguments","I remain firm in my conviction"]},
  ...
  {id:128, dim:"selfConfidence", w:1.1, text:"You prepared something carefully. Someone criticizes it unconstructively",opts:["It deeply and lastingly affects me","I'm touched but don't show it","I step back quickly","I don't care, my judgment is more reliable than theirs"]},
  ...
  {id:131, dim:"selfConfidence", w:1.0, text:"You present your work to a recognized expert. Their reaction is cold",opts:["I immediately think my work is worthless","I seriously doubt its quality","I remain confident despite the discomfort","I think they might be wrong"]},
  {id:132, dim:"selfConfidence", w:1.2, text:"You must give your opinion in a group of people you greatly esteem",opts:["I often agree to avoid disruption","I give a soft, consensual opinion","I give my real opinion tactfully","I give my opinion directly, even if it disrupts"]},
  ...
  {id:134, dim:"selfConfidence", w:1.1, text:"A very competent person questions your approach",opts:["I immediately question everything","I carefully reconsider","I listen attentively and integrate what makes sense","I defend my approach and explain why"]},
  {id:135, dim:"selfConfidence", w:1.0, text:"You must make an important decision in 60 seconds",opts:["I panic and ask for more time","I make a decision but stress about it","I make a decision fairly serenely","I love these situations, I'm in my element"]},
  {id:136, dim:"selfConfidence", w:1.1, text:"You apply for a role you're not 100% qualified for",opts:["I don't apply if I don't meet all criteria","I apply but expect to be filtered out","I apply and make a case for my potential","I apply confidently and highlight my unique strengths"]},
  {id:137, dim:"selfConfidence", w:1.0, text:"Someone more senior than you is wrong about a fact in a meeting",opts:["I say nothing","I find a way to hint at it politely afterward","I politely correct them in the moment","I directly correct them and explain why"]},
  {id:138, dim:"selfConfidence", w:0.8, text:"You learn a new skill and others seem to progress faster",opts:["I feel like I'm naturally worse at this","I feel self-conscious but keep going","I focus on my own progress","I don't compare myself to others at all"]},
  {id:139, dim:"selfConfidence", w:1.2, text:"You receive a lot of praise for your work",opts:["I wonder if they really mean it","I appreciate it but feel it might be exaggerated","I accept it and feel good","I feel it's well-deserved and expected"]},
  {id:140, dim:"selfConfidence", w:1.0, text:"You're in a room full of experts in a field you know less well",opts:["I stay quiet to avoid looking uninformed","I speak only when I'm very sure","I contribute when I have something to add","I engage confidently and ask good questions"]},
  {id:141, dim:"selfConfidence", w:1.1, text:"Someone repeatedly dismisses your ideas in a group setting",opts:["I stop sharing ideas in that group","I become more hesitant about sharing","I address it directly or change my approach","I keep sharing and let the ideas speak for themselves"]},
  {id:142, dim:"selfConfidence", w:1.0, text:"You're asked to lead a project you've never done before",opts:["I'm very reluctant and try to defer","I accept nervously and rely heavily on others","I accept and trust myself to figure it out","I embrace it as an opportunity to grow"]},
  {id:143, dim:"selfConfidence", w:0.9, text:"You attempt something new and fail the first time",opts:["I take it as a sign it's not for me","I feel self-doubt creep in","I see it as a normal part of learning","I expect early failure and feel neutral about it"]},
  {id:144, dim:"selfConfidence", w:1.2, text:"You make a controversial decision that most people around you disagree with",opts:["I immediately reconsider","I feel very uncomfortable with the disagreement","I stay the course while acknowledging their views","I feel more confident when I go against the grain"]},
  {id:145, dim:"selfConfidence", w:1.0, text:"You're asked to negotiate a salary or price",opts:["I find it very uncomfortable and avoid it","I negotiate a little but settle quickly","I negotiate clearly and assertively","I enjoy negotiating and go for the best outcome"]},
  {id:146, dim:"selfConfidence", w:1.1, text:"You're publicly praised and then criticized shortly after",opts:["The criticism cancels out the praise for me","I try to focus on the positive but struggle","I take both with some perspective","I don't let either define how I see myself"]},
  {id:147, dim:"selfConfidence", w:1.0, text:"You try something creative and show it to others. They're unimpressed",opts:["I feel like I shouldn't have shared it","I feel embarrassed and less likely to share again","I note the feedback and reflect on it","I appreciate the feedback but trust my own judgment"]},
  {id:148, dim:"selfConfidence", w:0.8, text:"You're about to do something for the first time with an audience watching",opts:["I try to avoid being observed","I feel very self-conscious","I'm a bit nervous but go for it","I perform better with people watching"]},
  {id:149, dim:"selfConfidence", w:1.2, text:"You're contradicted in an area you consider yourself an expert in",opts:["I immediately become defensive","I feel my credibility is being questioned","I engage with their argument carefully","I welcome the challenge and engage from a place of security"]},
  {id:150, dim:"selfConfidence", w:1.0, text:"You set a goal and don't achieve it",opts:["I feel like I'm not capable","I wonder if the goal was realistic for me","I review what went wrong and adjust","I see it as useful data to refine my approach"]},
  ...
  {id:157, dim:"moneyMindset", w:1.1, text:"You could earn more but it involves financial uncertainty for 6 months",opts:["Out of the question, I need stability","It's tempting but too risky for me","I'd accept if I have emergency savings","I accept without hesitation, the game is worth it"]},
  {id:158, dim:"moneyMindset", w:1.2, text:"You're asked to lend a significant amount to someone who needs it",opts:["I feel a lot of discomfort at the idea","I help but will miss the money","I help if I have the capacity","I help without qualm, it's just money"]},
  {id:159, dim:"moneyMindset", w:0.9, text:"You make money easily during a good streak",opts:["I feel guilty or anxious","I'm happy but cautious","I savor it and reinvest intelligently","I immediately look for ways to amplify"]},
  ...
  {id:161, dim:"moneyMindset", w:1.1, text:"You find a $20 bill on the ground",opts:["I feel uncomfortable keeping it","I keep it but feel slight guilt","I keep it without much thought","I'm simply pleased with the little bonus"]},
  {id:162, dim:"moneyMindset", w:1.0, text:"Someone offers to pay for dinner",opts:["I insist on splitting, I'm uncomfortable being treated","I accept but feel I should reciprocate immediately","I accept graciously and reciprocate naturally later","I accept easily and don't overthink the reciprocation"]},
  {id:163, dim:"moneyMindset", w:0.8, text:"You're thinking about asking for a pay raise",opts:["I feel very uncomfortable even thinking about it","I'd prepare extensively and still hesitate","I'd prepare my case and ask confidently","I'm comfortable advocating for my worth"]},
  {id:164, dim:"moneyMindset", w:1.2, text:"You receive an unexpected bonus at work",opts:["I feel like I should be careful with it","I save most of it as a precaution","I use some, save some deliberately","I immediately think of how to put it to work"]},
  {id:165, dim:"moneyMindset", w:1.0, text:"You're thinking about charging for a skill or service you offer",opts:["I feel very uncomfortable asking for money","I tend to undercharge to avoid discomfort","I research fair market rates and charge accordingly","I confidently price based on my value"]},
  {id:166, dim:"moneyMindset", w:1.1, text:"A financial advisor recommends a strategy with higher risk and higher potential reward",opts:["I reject it immediately","I consider it but likely stick with safer options","I evaluate it carefully and keep an open mind","I'm excited by the upside and want to explore it"]},
  {id:167, dim:"moneyMindset", w:1.0, text:"You see a peer earning significantly more than you in a similar role",opts:["It creates a lot of anxiety for me","I feel unsettled and compare myself","I note it and think about what that means for me","I use it as useful market information and act on it"]},
  {id:168, dim:"moneyMindset", w:0.9, text:"You are gifted at something but hate monetizing it",opts:["I refuse to monetize what I love","I've tried but felt deeply uncomfortable","I've made peace with it gradually","I see money as enabling me to do more of what I love"]},
  {id:169, dim:"moneyMindset", w:1.2, text:"You're considering a high-risk, high-reward business idea",opts:["The financial risk stops me cold","I'd research it extensively before committing anything","I'd start small and scale if it works","I'd pursue it wholeheartedly"]},
  {id:170, dim:"moneyMindset", w:1.0, text:"You're asked to split a restaurant bill and someone underpays",opts:["I cover the difference without saying anything","I feel uncomfortable but say nothing","I mention it diplomatically","I clearly address it without hesitation"]},
  ...
  {id:174, dim:"moneyMindset", w:1.2, text:"You find out you've been overpaying for a service for years",opts:["I feel terrible about the wasted money","I'm frustrated but fix it and move on","I cancel or renegotiate and feel fine","I see it as a useful lesson and don't dwell on it"]},
  {id:175, dim:"moneyMindset", w:1.0, text:"Someone you respect tells you money isn't important",opts:["I deeply agree and feel validated","I mostly agree though I have some reservations","I think it depends on what you do with it","I respectfully disagree — money is a powerful tool"]},

  // ── DISCIPLINE (25) ──
  {id:176, dim:"discipline", w:1.2, text:"You have a well-defined morning routine. One morning everything goes wrong",opts:["I abandon the routine that day","I skip a few steps but get into it","I readapt to do everything despite constraints","I maintain it no matter what, the routine is sacred"]},
  {id:177, dim:"discipline", w:1.0, text:"You follow a fitness program. You miss a few days",opts:["I give up, I already failed","I feel guilty and struggle to get back","I resume without self-flagellation","I resume immediately the next day without thinking about it"]},
  ...
  {id:179, dim:"discipline", w:1.3, text:"You have a task list. An interesting unplanned task comes up",opts:["I do the new task immediately","I start it and abandon the list","I note the new task and finish what's planned","I categorically refuse to deviate from my plan"]},
  {id:180, dim:"discipline", w:1.0, text:"Someone proposes an incredible opportunity that doesn't fit your current projects",opts:["I jump on it, rules adapt","I'm very tempted and probably say yes","I carefully weigh it before deviating","I decline, I stick to my plan"]},
  {id:181, dim:"discipline", w:1.1, text:"You told someone you'd do something and you no longer feel like it",opts:["I let them know and don't do it","I do it halfway then stop","I do it even without wanting to, it's my commitment","I had said it, I'll do it completely"]},
  ...
  {id:183, dim:"discipline", w:0.9, text:"You have a monthly budget set. An unexpected tempting expense comes up",opts:["I buy it, the budget is just indicative","I buy it but feel guilty","I consider if I can readjust","I resist, the budget isn't made to be ignored"]},
  {id:184, dim:"discipline", w:1.0, text:"You need to wake up early for something important. The alarm goes off",opts:["Multiple snoozes, I wake up in a rush","One snooze then I get up","I get up directly despite the fatigue","I anticipated it, I was already awake"]},
  {id:185, dim:"discipline", w:1.1, text:"You set a firm limit in a relationship. The person pushes it",opts:["I give in to avoid conflict","I give in a bit but feel uncomfortable","I maintain calmly and firmly","I maintain and clearly explain the consequences"]},
  {id:186, dim:"discipline", w:1.0, text:"You commit to a 30-day challenge (no alcohol, daily exercise, etc.). On day 8 you slip",opts:["I consider the challenge failed and stop","I feel bad and struggle to restart","I accept the slip and get right back on track","I treat it as noise in the process and continue"]},
  {id:187, dim:"discipline", w:1.1, text:"You're on a diet and you're offered your favorite food",opts:["I rarely resist","I often resist but it's a real struggle","I resist most of the time","I've made peace with my choice and resist easily"]},
  {id:188, dim:"discipline", w:1.0, text:"You plan to sleep 8 hours but get caught up in something interesting",opts:["I stay up as long as I want","I stay up later than I should fairly often","I finish what I'm doing but accept going to bed late","I stop at my bedtime regardless of what I'm doing"]},
  ...
  {id:190, dim:"discipline", w:1.2, text:"You're practicing a sport and your coach asks you to work on a weakness",opts:["I focus on what I'm already good at","I work on it occasionally","I work on it consistently as instructed","I make it the core of my practice until it's a strength"]},
  {id:191, dim:"discipline", w:1.0, text:"You set a deadline for a personal project. As it approaches, you realize you're behind",opts:["I usually extend the deadline","I rush at the last minute","I adjust scope to meet the deadline","I started early so I'm rarely in this situation"]},
  {id:192, dim:"discipline", w:1.1, text:"A friend wants to chat when you're in a deep work session",opts:["I stop and chat, I'll resume later","I chat briefly then struggle to refocus","I let them know I'll connect later","I'm in focus mode and almost never break it"]},
  {id:193, dim:"discipline", w:1.0, text:"You're intermittent fasting. Your eating window hasn't started but you're hungry",opts:["I eat, the plan is flexible","I eat if I'm very hungry","I drink water and distract myself","I stick to the window, discomfort is part of the process"]},
  ...
  {id:195, dim:"discipline", w:1.2, text:"You're saving toward a specific goal. A tempting purchase comes up",opts:["I buy it, the goal can wait","I often make exceptions","I buy very rarely and feel the pull","I almost never deviate from my savings goal"]},
  {id:196, dim:"discipline", w:1.0, text:"You follow a study plan. You fall behind by one chapter",opts:["I often let the gap grow","I catch up but feel guilty","I catch up steadily without drama","I rarely fall behind and recover immediately when I do"]},
  {id:197, dim:"discipline", w:1.1, text:"You plan to disconnect from screens for an evening. Your favorite show releases a new episode",opts:["I watch it, plans are flexible","I watch just this one episode","I note it and watch tomorrow as planned","I stick to my plan and watch it another time"]},
  ...
  {id:200, dim:"discipline", w:1.2, text:"You're given full freedom over how to structure your workday",opts:["I flow with whatever feels right each day","I have loose intentions but adapt a lot","I build a structure and follow it mostly","I design an optimized schedule and stick to it rigorously"]},
];
